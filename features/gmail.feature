Feature: Gmail
  ...
  Background:
    Given there are the following users:
      ...
      | rubensaavedraperez@gmail.com | jp5.28qt4 |
    And Action Mailer delivers via SMTP
    Given there is a project called "TextMate 2"
    And "alice@ticketee.com" can view the "TextMate 2" project
    And "rubensaavedraperez@gmail.com" can view the "TextMate 2" project
    And "rubensaavedraperez@gmail.com" has created a ticket for this project:
      | title        | description       |
